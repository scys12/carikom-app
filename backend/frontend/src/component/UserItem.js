                        ...
                        <Row className="show-grid text-center">
                            {itemContent.map(item =>
                                <div key={item.id} className="item-wrapper">
                                    <Card>
                                        <div className={item.isBought === 1 ? 'item-card-img text-center' : 'text-center'}>{item.isBought === 1 && <div className="item-bought">Laku</div>}<Card.Img variant="top" src={`/images/${item.category.name}.png`} className="item-img" /></div>
                                        <Card.Body>
